...
import {
  ...
  VariableRateConfig,
  FixedRateConfig,
} from "../clients/gem-farm.client";
import { WhitelistType } from "../clients/gem-bank.client";
import { programs } from "@metaplex/js";
import { Wallet } from "@solana/wallet-adapter-react";

export async function initGemFarm(conn: Connection, wallet?: Wallet) {
  ...
  return new GemFarm(
    conn,
    walletToUse as typeof anchor.Wallet,
    farmIdl,
    bankIdl
  );
}
